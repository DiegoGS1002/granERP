<div class="nx-form-page">
    ...
    <div class="nx-form-header">
        ...
        <h1 class="nx-form-title">{{ $isEditing ? 'Editar Fornecedor' : 'Adicionar Fornecedor' }}</h1>
        <p class="nx-form-subtitle">{{ $isEditing ? 'Atualize os dados do fornecedor' : 'Preencha os dados do novo fornecedor' }}</p>
    </div>
    ...
    <form wire:submit="save">
        ...
        <div class="nx-form-card">
            <div class="nx-form-section">
                <div class="nx-form-section-header">
                    ...
                    <h3 class="nx-form-section-title">Informacoes da Empresa</h3>
                </div>
                <div class="grid grid-2">
                    <div class="nx-field">
                        <label>Razao Social</label>
                        <input type="text" wire:model.blur="social_name" placeholder="Nome da empresa" required>
                    </div>
                    <div class="nx-field">
                        <label>CNPJ</label>
            ...
            <div class="nx-form-section">
                <div class="nx-form-section-header">
                    ...
                    <h3 class="nx-form-section-title">Endereco</h3>
                </div>
                <div class="grid grid-2" style="margin-bottom:16px;">
                    <div class="nx-field">
                        <label>Rua</label>
                        <input type="text" wire:model.blur="address_street" placeholder="Nome da rua" required>
                    </div>
                    <div class="nx-field">
                        <label>Numero</label>
                        <input type="text" wire:model.blur="address_number" placeholder="N" required>
                    </div>
                </div>
                <div class="grid grid-3" style="margin-bottom:16px;">
                    <div class="nx-field">
                        <label>Bairro</label>
                        <input type="text" wire:model.blur="address_district" placeholder="Bairro" required>
                    </div>
                    <div class="nx-field">
                        <label>Cidade</label>
                        <input type="text" wire:model.blur="address_city" placeholder="Cidade" required>
                    </div>
                    <div class="nx-field">
                        <label>UF</label>
                        <input type="text" wire:model.blur="address_state" maxlength="2" placeholder="UF" required>
                    </div>
                </div>
                <div class="grid grid-2">
                    <div class="nx-field">
                        <label>CEP</label>
                        <input type="text" wire:model.blur="address_zip_code" placeholder="00000-000" required>
                    </div>
                    <div class="nx-field">
                        <label>Complemento</label>
                        <input type="text" wire:model.blur="address_complement" placeholder="Apto, sala, bloco..." required>
                    </div>
                </div>
            </div>
            ...
            <div class="nx-form-section">
                ...
                <div class="grid grid-2">
                    ...
                    <div class="nx-field">
                        <label>E-mail</label>
                        <input type="email" wire:model.blur="email" placeholder="contato@fornecedor.com" required>
                    </div>
                </div>
            </div>
            ...
            <div class="nx-form-section">
                <div class="nx-form-section-header">
                    ...
                    <h3 class="nx-form-section-title">Responsavel</h3>
                </div>
                <div class="grid grid-1">
                    <div class="nx-field">
                        <label>Nome do Contato Principal</label>
                        <input type="text" wire:model.blur="name" placeholder="Nome completo do responsavel" required>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="nx-form-footer">
            ...
            <button type="submit" class="nx-btn nx-btn-primary">
                ...
                {{ $isEditing ? 'Salvar Alteracoes' : 'Salvar Fornecedor' }}
            </button>
        </div>
    </form>
</div>
